...
class AccuChekLogger {
    ...
    private var logFile: String {
        getDocumentsDirectory().appendingPathComponent("accuchek/accuchek_log.txt").path
    }

    private var logDir: String {
        getDocumentsDirectory().appendingPathComponent("accuchek").path
    }

    private var logFilePrev: String {
        getDocumentsDirectory().appendingPathComponent("accuchek/accuchek_log_prev.txt").path
    }
