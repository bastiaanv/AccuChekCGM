...
In case an issue is not covered by the FAQ below please reach out on the Loop Zulipchat or open a GitHub issue. Please make sure to attach your logs when you file a report. You can find them by going to the Accu-Chek settings menu and pressing the "Share Accu-Chek Logs" button.
...
Please join the Loop Zulipchat at https://loop.zulipchat.com/
